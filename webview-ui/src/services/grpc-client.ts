...
export class StateServiceClient extends ProtoBusClient {
    ...
    static async togglePlanActMode(request: proto.cline.TogglePlanActModeRequest): Promise<proto.cline.Boolean> {
		return this.makeRequest("togglePlanActMode", request)
	}
